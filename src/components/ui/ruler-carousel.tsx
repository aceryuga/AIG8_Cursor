...
export function RulerCarousel({
  ...
  // Start with the middle set, item 4 (CENTURY)
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-[#F9F7E7]">
              ...
              return (
                <motion.button
                  ...
                  className={`text-4xl md:text-6xl font-bold whitespace-nowrap cursor-pointer flex items-center justify-center ${
                    isActive
                      ? "text-[#053725]"
                      : "text-[#053725]/40 hover:text-[#053725]/70"
                  }`}
                  animate={{
      ...
      <div className="flex items-center justify-center gap-4 mt-10">
        ...
        >
          <Rewind className="w-5 h-5 text-[#053725]/80 hover:text-[#053725]" />
        </button>
        
        <div className="flex items-center gap-2">
          <span className="text-sm font-medium text-[#053725]">
            {currentPage}
          </span>
          <span className="text-sm text-[#053725]/60">
            /
          </span>
          <span className="text-sm font-medium text-[#053725]">
            {totalPages}
        ...
        >
          <FastForward className="w-5 h-5 text-[#053725]/80 hover:text-[#053725]" />
        </button>
      </div>
    </div>
  );
